...
<img src="https://cdn2.fptshop.com.vn/unsafe/640x0/filters:quality(100)/2022_5_31_637896077154349058_visual-studio-code-jpg.jpg" alt="VS Code" style="width: 55px; vertical-align: middle; margin-right: 15px;"/> <img src="./assets/html5.svg" alt="HTML5" style="width: 55px; vertical-align: middle; margin-right: 15px;"/> <img src="./assets/css3.svg" alt="CSS3" style="width: 55px; vertical-align: middle; margin-right: 15px;"/> <img src="./assets/javascript.svg" alt="JavaScript" style="width: 55px; vertical-align: middle; margin-right: 15px;"/> <img src="./assets/php.svg" alt="PHP" style="width: 76px; vertical-align: middle; margin-right: 15px;"/>
